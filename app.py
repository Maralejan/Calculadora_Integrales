...
# Configurar precisión decimal alta (20 dígitos para no perder precisión)
getcontext().prec = 20
...
def trapecio(f, a, b, n):
    ...
    # f requiere float, pero resultado se vuelve Decimal
...
def resolver():
    ...
    try:
        ...
        # Evaluar función usuario con sympy
        x, y = symbols('x y')
        contexto = {
            "x": x, "y": y, "pi": pi,
